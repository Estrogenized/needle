...
public interface Char2CharBiConsumer extends BiConsumer<@NotNull Character, @NotNull Character> {
    ...
    default @Contract(pure = true) Char2CharBiConsumer andThenChar(final @NotNull Char2CharBiConsumer after) {
        return (l, r) -> {
            this.acceptChar(l, r);
